              ...
              <div class="container "> 
                  <div class="row ">
                    ...
                    <div class="col-lg-3 col-sm-3 ">
                      ...
                      <form  action="index1.php" method="POST" class="" enctype="multipart/form-data" onsubmit="return validarFormulario()">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                              <label for="file">SELECCIONE SU "LOGOTIPO DE SU EMPRESA":[ SOLO PUEDE INGRESAR ARCHIVOS .jpg ]</label>
...
function validarExtimg()
{
    ...
    if(!Ajpg){
        alert('usted no ha seleccionado una imagen jpg');
        //archivoInput.value = '';
        archivoInput.value = '';
        return false;
    }
...
<script>
  function validarFormulario(){
    ...
    var files1 = document.getElementById('archivoInput1');
    //alert file1;
